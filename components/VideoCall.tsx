            ...
            {permissionError ? (
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                        <div className="relative aspect-[3/4] sm:aspect-video rounded-[32px] overflow-hidden bg-couple-text shadow-love group border-4 border-white">
                            <video
                                ref={localVideoRef}
                                autoPlay
                                playsInline
                    ...
                    {Object.entries(remoteStreams).map(([peerId, stream]) => {
                        ...
                        return (
                            <div key={peerId} className="flex flex-col gap-2">
                                <div className="relative aspect-[3/4] sm:aspect-video rounded-[32px] overflow-hidden bg-couple-deep shadow-love group border-4 border-white">
                    ...
                    {Object.keys(remoteStreams).length === 0 && users.length > 1 && (
                        <div className="relative aspect-[3/4] sm:aspect-video rounded-[32px] overflow-hidden bg-couple-soft flex flex-col items-center justify-center border-4 border-white border-dashed">
