    ...
    <div className="min-h-screen bg-couple-background font-love pb-20">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-6 sm:pt-10 animate-fade-up pb-10">
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-6 lg:gap-10 items-start">
          ...
          {/* Main Stage */}
          <div className="w-full lg:col-span-8 space-y-6 lg:space-y-10">
          ...
          {/* Sidebar */}
          <div className="w-full lg:col-span-4 space-y-6 lg:space-y-10 lg:sticky lg:top-24">
            <div className="h-[450px] sm:h-[550px] lg:h-[calc(100vh-250px)]">
              <Chat
                messages={messages}
